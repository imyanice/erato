		...
		<>
			...
			{results.map((result) => (
				<button
					...
					<img alt={`${result.title}'s cover`} className='h-24 w-24 rounded-sm' src={result.cover} />
					<div className='pl-2'>
						<div className='text-grow text-sm font-bold pb-1 justify-start flex'>{result.title}</div>
